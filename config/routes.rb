Myquestis::Application.routes.draw do
  ...
  match '/get_started' => 'site#get_started'
  match '/why' => 'site#why'
  match '/who' => 'site#who'
  match '/you_decide' => 'site#you_decide'
  match '/talk' => 'site#talk'
  match '/goals' => 'site#goals'
  match '/commitment' => 'site#commitment'
